...
def watermark(image):
	...
	tiled = np.tile(the_2x2,(128,256))								#So the matrix spans the entire image
...
def decode(filename):
	...
	first = Image.open("../../../Images/Embedded/5. Watermark/Ordered/2x2/"+filename)
	firstArray = np.array(first, 'float64')
	second = Image.open("../../../Images/Embedded/5. Watermark/Ordered/2x2/"+filename).rotate(180)
...
for file in fileList:
	...
	original = Image.open("../../../Images/Basic Halftone/Ordered/2x2/"+filename)
	...
	imageConverted.save("../../../Images/Embedded/5. Watermark/Ordered/2x2/"+filename)

	start_time = time.time()
	decodeXOR = decode(filename)
	decryptTime = time.time() - start_time

	decodeXOR.save("../../../Images/Embedded/5. Watermark/Ordered/2x2/XOR/"+filename)
