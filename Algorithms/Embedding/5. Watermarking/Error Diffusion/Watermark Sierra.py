...
def decode(filename):
	...
	first = Image.open("../../../Images/Embedded/5. Watermark/Error Diffusion/Sierra/"+filename)
	firstArray = np.array(first, 'float64')
	second = Image.open("../../../Images/Embedded/5. Watermark/Error Diffusion/Sierra/"+filename).rotate(180)
	...
	return newImage												#Return the XOR images
...
for file in fileList:
	...
	original = Image.open("../../../Images/Basic Halftone/Error Diffusion/Sierra/"+filename)
	...
	imageConverted.save("../../../Images/Embedded/5. Watermark/Error Diffusion/Sierra/"+filename)

	start_time = time.time()
	decodeXOR = decode(filename)
	decryptTime = time.time() - start_time

	decodeXOR.save("../../../Images/Embedded/5. Watermark/Error Diffusion/Sierra/XOR/"+filename)
#	
