...
fileList = []
for file in os.listdir("../../../Images/Basic Halftone/Stippled/6 Gradient/"):
...
for file in fileList:						#For every file in the sorted file list	
	...
	image = Image.open("../../../Images/Basic Halftone/Stippled/6 Gradient/"+filename)				#Open halftoned image
	original = Image.open("../../../Images/Basic Halftone/Stippled/6 Gradient/"+filename)				#For comparing
	...
	imageConverted.save("../../../Images/Embedded/2. Density Text/Stippled/6 Gradient/"+filename)


	imageDecode = Image.open("../../../Images/Embedded/2. Density Text/Stippled/6 Gradient/"+filename)
	start_time = time.time()
	decode(imageDecode)
