...
fileList = []
for file in os.listdir("../../../Images/Basic Halftone/Ordered/2x2/"):
...
for file in fileList:						#For every file in the sorted file list	
	...
	image = Image.open("../../../Images/Basic Halftone/Ordered/2x2/"+filename)				#Open halftoned image
	original = Image.open("../../../Images/Basic Halftone/Ordered/2x2/"+filename)				#For comparing
	...
	imageConverted.save("../../../Images/Embedded/2. Density Text/Ordered/2x2/"+filename)


	imageDecode = Image.open("../../../Images/Embedded/2. Density Text/Ordered/2x2/"+filename)
	start_time = time.time()
	decode(imageDecode)
