...
fileList = []
for file in os.listdir("../../../Images/Basic Halftone/Error Diffusion/Jarvis/"):
...
for file in fileList:						#For every file in the sorted file list	
	...
	image = Image.open("../../../Images/Basic Halftone/Error Diffusion/Jarvis/"+filename)				#Open halftoned image
	original = Image.open("../../../Images/Basic Halftone/Error Diffusion/Jarvis/"+filename)				#For comparing
	...
	imageConverted.save("../../../Images/Embedded/2. Density Text/Error Diffusion/Jarvis/"+filename)


	imageDecode = Image.open("../../../Images/Embedded/2. Density Text/Error Diffusion/Jarvis/"+filename)
	start_time = time.time()
	decode(imageDecode)
