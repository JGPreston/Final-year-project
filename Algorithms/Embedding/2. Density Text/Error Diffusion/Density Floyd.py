...
fileList = []
for file in os.listdir("../../../Images/Basic Halftone/Error Diffusion/Floyd/"):
...
for file in fileList:						#For every file in the sorted file list	
	...
	image = Image.open("../../../Images/Basic Halftone/Error Diffusion/Floyd/"+filename)				#Open halftoned image
	original = Image.open("../../../Images/Basic Halftone/Error Diffusion/Floyd/"+filename)				#For comparing
	...
	imageConverted.save("../../../Images/Embedded/2. Density Text/Error Diffusion/Floyd/"+filename)


	imageDecode = Image.open("../../../Images/Embedded/2. Density Text/Error Diffusion/Floyd/"+filename)
	start_time = time.time()
	decode(imageDecode)
