...
for file in fileList:						#For every file in the sorted file list	
	...
	imageConverted.save("../../../Images/Embedded/1. Basic Text/Stippled/2 Gradient/"+filename)


	imageDecode = Image.open("../../../Images/Embedded/1. Basic Text/Stippled/2 Gradient/"+filename)
	start_time = time.time()
	decode(imageDecode)
