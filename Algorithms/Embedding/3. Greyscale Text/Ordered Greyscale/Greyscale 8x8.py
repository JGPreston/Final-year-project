...
the_8x8 = np.divide(the_8x8,64)
tiled = np.tile(the_8x8,(64,64))
...
for file in fileList:									#For every file in the sorted file list
	...
	original = Image.open("../../../Images/Basic Halftone/Ordered/8x8/"+filename)		#For comparing against original
	print(filename)
	...
	imageConverted.save("../../../Images/Embedded/3. Greyscale Text/Ordered/8x8/"+filename)


	imageDecode = Image.open("../../../Images/Embedded/3. Greyscale Text/Ordered/8x8/"+filename)
	start_time = time.time()
