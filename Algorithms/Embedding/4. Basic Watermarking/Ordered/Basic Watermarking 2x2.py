...
for file in fileList:
	...
	image = Image.open("../../../Images/Basic Halftone/Ordered/2x2/"+filename)
	...
	imageConverted.save("../../../Images/Embedded/4. Basic Watermark/Ordered/2x2/"+filename)


	toAnalyse = Image.open("../../../Images/Embedded/4. Basic Watermark/Ordered/2x2/"+filename)
