...
for file in fileList:
	...
	image = Image.open("../../../Images/Basic Halftone/Ordered/8x8/"+filename)
	...
	imageConverted.save("../../../Images/Embedded/4. Basic Watermark/Ordered/8x8/"+filename)


	toAnalyse = Image.open("../../../Images/Embedded/4. Basic Watermark/Ordered/8x8/"+filename)
