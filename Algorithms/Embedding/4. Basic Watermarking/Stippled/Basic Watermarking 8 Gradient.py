...
for file in fileList:
	...
	image = Image.open("../../../Images/Basic Halftone/Stippled/8 Gradient/"+filename)
	...
	imageConverted.save("../../../Images/Embedded/4. Basic Watermark/Stippled/8 Gradient/"+filename)


	toAnalyse = Image.open("../../../Images/Embedded/4. Basic Watermark/Stippled/8 Gradient/"+filename)
