...
for file in fileList:
	...
	image = Image.open("../../../Images/Basic Halftone/Stippled/4 Gradient/"+filename)
	...
	imageConverted.save("../../../Images/Embedded/4. Basic Watermark/Stippled/4 Gradient/"+filename)


	toAnalyse = Image.open("../../../Images/Embedded/4. Basic Watermark/Stippled/4 Gradient/"+filename)
