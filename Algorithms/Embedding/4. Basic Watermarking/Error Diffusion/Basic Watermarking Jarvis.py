...
for file in fileList:
	...
	image = Image.open("../../../Images/Basic Halftone/Error Diffusion/Jarvis/"+filename)
	...
	imageConverted.save("../../../Images/Embedded/4. Basic Watermark/Error Diffusion/Jarvis/"+filename)


	toAnalyse = Image.open("../../../Images/Embedded/4. Basic Watermark/Error Diffusion/Jarvis/"+filename)
