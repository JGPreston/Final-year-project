...
for file in fileList:
	...
	image = Image.open("../../../Images/Basic Halftone/Error Diffusion/Floyd/"+filename)
	...
	imageConverted.save("../../../Images/Embedded/4. Basic Watermark/Error Diffusion/Floyd/"+filename)


	toAnalyse = Image.open("../../../Images/Embedded/4. Basic Watermark/Error Diffusion/Floyd/"+filename)
