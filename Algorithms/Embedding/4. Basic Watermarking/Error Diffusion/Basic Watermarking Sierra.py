...
for file in fileList:
	...
	image = Image.open("../../../Images/Basic Halftone/Error Diffusion/Sierra/"+filename)
	...
	imageConverted.save("../../../Images/Embedded/4. Basic Watermark/Error Diffusion/Sierra/"+filename)


	toAnalyse = Image.open("../../../Images/Embedded/4. Basic Watermark/Error Diffusion/Sierra/"+filename)
